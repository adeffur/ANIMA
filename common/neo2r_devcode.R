...
library(neo2R)
dburl<-"http://192.168.65.2:8474/db/data/"
graph<-startGraph(dburl,database="animadb",username="neo4j",password="anima")

query<-"CREATE (n:wgcna {name:'yellow'})"

query<-"MATCH (n:wgcna) RETURN * LIMIT 10"
